"""Script para executar extração de produtos Elmar."""
...
def load_supplier_config():
    """Carrega configuração do fornecedor Elmar."""
    ...
    raise ValueError("Configuração do fornecedor Elmar não encontrada")


def main():
    """Executa extração Elmar."""
    print("=" * 60)
    print("EXTRAÇÃO ELMAR - Made in Natural")
    print("=" * 60)
